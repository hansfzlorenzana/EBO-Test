...
my_ticker = "UK-Conservatives-Seats-2024" #MUST be in the title of "price_log" file
my_html_address = "UK-Conservatives-Seats-2024" #program automatically inserts ".html"
my_root = "UK-Conservatives-Seats-2024"# no slashes before or after
...
my_Betfair_URL = "https://ero.betfair.ro/www/sports/exchange/readonly/v1/bymarket?_ak=nzIFcwyWhrlwYMrh&alt=json&currencyCode=USD&locale=en_GB&marketIds=1.223763243&rollupLimit=25&rollupModel=STAKE&types=MARKET_STATE,MARKET_RATES,MARKET_DESCRIPTION,EVENT,RUNNER_DESCRIPTION,RUNNER_STATE,RUNNER_EXCHANGE_PRICES_BEST,RUNNER_METADATA,MARKET_LICENCE,MARKET_LINE_RANGE_INFO"
...
my_Polymarket_URL = "https://polymarket.com/event/uk-election-how-many-seats-will-labour-win"

column_title = "UK Conservatives Seats 2024"
...
Polymarket_new_manual_entry = [
        ...
        (None,"250-299",""),
        (None,"300-349",""),
        ((501463,"Yes"),"325 or less",""),
        ((501464,"Yes"),"325-349",""),
        ((501465,"Yes"),"350-374",""),
        ((501466,"Yes"),"375-399",""),
        ((501467,"Yes"),"400-424",""),
        ((501468,"Yes"),"425-449",""),
        ((501469,"Yes"),"450 or more",""),
        # ((254000,"Yes"),"DeSantis",""),
        # ((253999,"Yes"),"Kennedy",""),
        # ((254005,"Yes"),"Carson",""),
        # ((254112,"Yes"),"Vance",""),
...
race_description = """UK Conservative Party Seats in 2024"""
