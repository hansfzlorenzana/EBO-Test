...
my_ticker = "Senate-Control-2024" #MUST be in the title of "price_log" file
my_html_address = "Senate-Control-2024" #program automatically inserts ".html"
my_root = "Senate-Control-2024"# no slashes before or after
...
my_Betfair_URL = "https://ero.betfair.ro/www/sports/exchange/readonly/v1/bymarket?_ak=nzIFcwyWhrlwYMrh&alt=json&currencyCode=USD&locale=en_GB&marketIds=1.225479090&rollupLimit=25&rollupModel=STAKE&types=MARKET_STATE,MARKET_RATES,MARKET_DESCRIPTION,EVENT,RUNNER_DESCRIPTION,RUNNER_STATE,RUNNER_EXCHANGE_PRICES_BEST,RUNNER_METADATA,MARKET_LICENCE,MARKET_LINE_RANGE_INFO"
...
my_Polymarket_URL = "https://polymarket.com/event/which-party-will-control-the-us-senate-after-the-2024-election"

column_title = "Senate Control 2024"
...
Polymarket_new_manual_entry = [
        ((252298,"Democrats"),"DEM",""),
        ((252298,"Republicans"),"REP",""),
        ]

race_description = """Senate Control 2024"""
