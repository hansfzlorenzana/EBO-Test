...
my_ticker = "UK-Labour-Seats-2024" #MUST be in the title of "price_log" file
my_html_address = "UK-Labour-Seats-2024" #program automatically inserts ".html"
my_root = "UK-Labour-Seats-2024"# no slashes before or after
...
my_Betfair_URL = "https://ero.betfair.ro/www/sports/exchange/readonly/v1/bymarket?_ak=nzIFcwyWhrlwYMrh&alt=json&currencyCode=USD&locale=en_GB&marketIds=1.229247851&rollupLimit=25&rollupModel=STAKE&types=MARKET_STATE,MARKET_RATES,MARKET_DESCRIPTION,EVENT,RUNNER_DESCRIPTION,RUNNER_STATE,RUNNER_EXCHANGE_PRICES_BEST,RUNNER_METADATA,MARKET_LICENCE,MARKET_LINE_RANGE_INFO"
...
column_title = "UK Labour Seats 2024"
...
race_description = """UK Labour Party Seats in 2024"""
