...
my_ticker = "DemocratVicePresident_2024" # MANUAL INPUT; MUST be in the title of "price_log" file
my_html_address = "DemocratVicePresident_2024" # MANUAL INPUT; program automatically inserts ".html"
my_root = "DemocratVicePresident_2024" # MANUAL INPUT; no slashes before or after
...
my_Smarkets_market_name = "2024 Democratic VP nominee" # MANUAL INPUT; This is case-sensitive

# For Betfair, it's the "1.223236887" that needs to be replaced, based on the similarly-formatted number in the Betfair URL
betfair_market_id = 1.190716127 # MANUAL INPUT
...
column_title = "DEM VP Nominee" # MANUAL INPUT
...
race_description = """Democrat Vice Presidential Nominee in 2024""" # MANUAL INPUT
...
fa = open('temp_server/ad_bar.txt','r')
ad_bar = fa.read()
fa.close()
