...
import re
import requests
# TODO: Handle maine and nebraska congressional districts
...
votes_dict = (9,3,11,6,54,10,7,3,30,16,4,4,19,11,6,6,8,8,2,10,11,15,10,6,10,4,3,6,4,14,5,28,16,3,17,7,8,19,4,9,3,11,40,6,3,13,12,4,10,3,1,1,)
final_dict = {}
Betfair_dummy = 0
...
def US_oddsfinder(state,race,cand_FULL_name,cand_last_name_PLUS_bid_PLUS_race,cand_last_name_PLUS_ask_PLUS_race,cand_last_name_PLUS_odds_PLUS_race):
    ...
    with open ("temp_server/StateMap2024/Betfarer/price_log_"+str(state)+".txt", "r") as myfile:
...
for number in range(0,52):
    ...
    fp = open("temp_server/StateMap2024/Betfarer/price_log_"+str(state)+".txt",'a')
...
# ftp.storbinary(str("STOR public_html/StateMap2024.html"), converted_DEM_HTML_string)
