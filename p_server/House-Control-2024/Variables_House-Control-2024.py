...
my_ticker = "House-Control-2024" #MUST be in the title of "price_log" file
my_html_address = "House-Control-2024" #program automatically inserts ".html"
my_root = "House-Control-2024"# no slashes before or after
...
my_Betfair_URL = "https://ero.betfair.ro/www/sports/exchange/readonly/v1/bymarket?_ak=nzIFcwyWhrlwYMrh&alt=json&currencyCode=USD&locale=en_GB&marketIds=1.225749946&rollupLimit=25&rollupModel=STAKE&types=MARKET_STATE,MARKET_RATES,MARKET_DESCRIPTION,EVENT,RUNNER_DESCRIPTION,RUNNER_STATE,RUNNER_EXCHANGE_PRICES_BEST,RUNNER_METADATA,MARKET_LICENCE,MARKET_LINE_RANGE_INFO"
...
my_Polymarket_URL = "https://polymarket.com/event/house-control-after-2024-election"

column_title = "House Control 2024"
...
Polymarket_new_manual_entry = [
        ((254600,"Democratic"),"DEM",""),
        ((254600,"Republican"),"REP",""),
        ]

race_description = """House Control 2024"""
