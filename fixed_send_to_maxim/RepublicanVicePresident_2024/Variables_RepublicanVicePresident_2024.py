...
MARKET_LINKS = {
        ...
        MARKET_POLYMARKET_CLOB: '<a href="https://polymarket.com/market/will-andrew-yang-win-the-democratic-primary-for-mayor-of-new-york-city-in-2021>Polymarket Clob</a>',
...
my_ticker = "RepublicanVicePresident_2024" #MUST be in the title of "price_log" file
my_html_address = "RepublicanVicePresident_2024" #program automatically inserts ".html"
my_root = "RepublicanVicePresident_2024"# no slashes before or after
...
# For Polymarket, find the market ID by searching in this link: https://strapi-matic.poly.market/markets?_limit=-1&active=true&closed=false
...
# For Polymarket Clob API, I'm still finding an easier way to find the token_ids
Polymarket_clob_manual_entry = [
        # In format ((token_id, "buy"),"candidate name to show on page","")
        ((2975288315924173918209311730624909848097839286331534835768142720275538797319,"Yes"),"Stefanik",""),
        ((8681488799805426581374614432361520707755745574387168934760752271171960047735,"Yes"),"Noem",""),
        ((21056138340027977486451014448644238520949874970921291724217025487600067588358,"Yes"),"TimScott",""),
        ((113297874929239967779744830186595640918817295241884449881295023927555996851230,"Yes"),"Ramaswamy",""),
        ((9182868580252318844077621077365897763724823946093441316622528681756725930720,"Yes"),"Haley",""),
        ((27872403525648426038942492530249180394015165966545971509745041158216544843032,"Yes"),"Lake",""),
        ((21056138340027977486451014448644238520949874970921291724217025487600067588358,"Yes"),"Donalds",""),
        ((113297874929239967779744830186595640918817295241884449881295023927555996851230,"Yes"),"DeSantis",""),
        ((9182868580252318844077621077365897763724823946093441316622528681756725930720,"Yes"),"Kennedy",""),
        ((27872403525648426038942492530249180394015165966545971509745041158216544843032,"Yes"),"Carson",""),
        ]
